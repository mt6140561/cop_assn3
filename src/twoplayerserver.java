...
//	        	 socket.setSoTimeout(1000);		
	        	...
	        	mes = mes +superball.vx+" "+superball.vy+" ";
	        	mes = mes +superspeedball.vx+" "+superspeedball.vy+" ";
	        	mes = mes +extralifeball.vx+" "+extralifeball.vy+" ";
	        	mes = mes +stonewallball.vx+" "+stonewallball.vy+" ";
	    		//	String message= ""+bats.get(2).y+" ";
