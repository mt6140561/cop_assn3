...
public class twoplayerserver extends JPanel implements ActionListener{
	 ...
	 * Create the panel.
	 */
	public twoplayerserver(int i,int k) {
...
//					System.out.println(bat.velo);
	...
	public void socketfn(){
		...
		if(abc==true){
			...
			String message= ""+bats.get(2).x+" "+bats.get(2).y+" "+bats.get(2).velo+" "+s;
			if(message.equals(null)){
				bats.get(0).toAI();
			}
		//	String message= ""+bats.get(2).y+" ";
	        ...
	        //	System.out.print("assa");
	        	...
	        	mes = mes + "a"+superball.vx+" "+superball.vy+" ";
	        	mes = mes + "b"+superspeedball.vx+" "+superspeedball.vy+" ";
	        	mes = mes + "c"+extralifeball.vx+" "+extralifeball.vy+" ";
	        	mes = mes + "d"+stonewallball.vx+" "+stonewallball.vy+" ";
	    		//	String message= ""+bats.get(2).y+" ";
	    			System.out.println(mes);
	    	            ( oose).writeObject(mes);
