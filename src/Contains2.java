...
/*
 * two player contains file
 */

public class Contains2 extends JPanel implements ActionListener{
...
//		bat.bats=bats;
	...
	public static void main (String[] args) throws Exception{
		...
		frame.setContentPane(new Contains2(4,number));
